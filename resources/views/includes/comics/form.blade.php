...
<div class="row">
    ...
    <div class="col-6">
        ...
        <input type="text" value="{{ $comic->description }}" class="form-control" id="description"
            name="description" placeholder="Insert description here">
    ...
    <div class="col-6">
        ...
        <input type="text" value="{{ $comic->sale_date }}" class="form-control" id="sale_date" name="sale_date"
            placeholder="Insert sale_date here">
